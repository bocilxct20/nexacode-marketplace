@component('emails.layouts.nexacode', [
    'title' => 'Selamat Bergabung sebagai Author',
    'actionText' => 'Mulai Upload Produk',
    'actionUrl' => route('author.products.create'),
    'actionColor' => 'success'
])
...
### Informasi Penting
- Semua produk akan melalui proses moderasi sebelum dipublikasikan
- Komisi platform standar adalah 15% per transaksi
