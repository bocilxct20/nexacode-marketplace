...
Kami sangat menghargai kontribusi kamu dalam membangun ekosistem marketplace yang berkualitas.
@else
Selamat! kamu baru saja mencapai milestone: **{{ $data['milestone'] }} Penjualan** di NexaCode.

---

## Pencapaian kamu
Ini adalah bukti dari dedikasi dan kualitas produk yang kamu tawarkan. Terus pertahankan standar tinggi kamu dan tingkatkan performa penjualan.
@endif
